...
from .views import JobListView, JobDetailView, apply_to_job, JobCreateView, JobUpdateView, JobDeleteView
from .views import JobListView, JobDetailView, apply_to_job, JobCreateView, JobUpdateView, MyApplicationsView
from . import views
